...
public class OrganizationService {
    ...
    public void registerOrganization(String name, String email, String address, Role role) {
        ...
        try {
            userUtilService.sendEmail(savedOrganization.getEmail(), newRandomGenPassword);
        } catch (Exception e) {
            throw new RuntimeException("Failed to send the email with the generated password.", e);
        }
    }
